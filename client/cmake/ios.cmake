...
if(DEFINED DEPLOY)
    set_target_properties(${PROJECT} PROPERTIES
        ...
        XCODE_ATTRIBUTE_PROVISIONING_PROFILE_SPECIFIER "${BUILD_IOS_PROFILE_DISTR}"
        XCODE_ATTRIBUTE_PROVISIONING_PROFILE_SPECIFIER[variant=Debug] "${BUILD_IOS_PROFILE_DEV}"
    )
else()
    set_target_properties(${PROJECT} PROPERTIES
