...
PageType {
    ...
    QtObject {
        ...
        readonly property string title: qsTr("Check the server for previously installed CottonVPN services")
    ...
    QtObject {
        ...
        readonly property var clickedHandler: function() {
            ...
            var descriptionText = qsTr("All installed CottonVPN services will still remain on the server.")
            var yesButtonText = qsTr("Continue")
            var noButtonText = qsTr("Cancel")
    ...
    QtObject {
        ...
        property bool isVisible: root.isServerWithWriteAccess
        readonly property string title: qsTr("Clear server from CottonVPN software")
        readonly property string description: ""
        readonly property var tColor: AmneziaStyle.color.vibrantRed
        readonly property var clickedHandler: function() {
            var headerText = qsTr("Do you want to clear server from CottonVPN software?")
            ...
            var yesButtonFunction = function() {
                if (ServersUiController.isDefaultServerCurrentlyProcessed() && ConnectionController.isConnected) {
                    PageController.showNotificationMessage(qsTr("Cannot clear server from CottonVPN software during active connection"))
                } else {
