...
# CottonVPN iOS-подпись: Team ID и имена provisioning-профилей из CI-секретов
[[ -n "$BUILD_VPN_DEVELOPMENT_TEAM" ]] && args+=("-DBUILD_VPN_DEVELOPMENT_TEAM=$BUILD_VPN_DEVELOPMENT_TEAM")
[[ -n "$BUILD_IOS_PROFILE_DISTR" ]]    && args+=("-DBUILD_IOS_PROFILE_DISTR=$BUILD_IOS_PROFILE_DISTR")
[[ -n "$BUILD_IOS_PROFILE_DEV" ]]      && args+=("-DBUILD_IOS_PROFILE_DEV=$BUILD_IOS_PROFILE_DEV")
[[ -n "$BUILD_IOS_NE_PROFILE_DISTR" ]] && args+=("-DBUILD_IOS_NE_PROFILE_DISTR=$BUILD_IOS_NE_PROFILE_DISTR")
[[ -n "$BUILD_IOS_NE_PROFILE_DEV" ]]   && args+=("-DBUILD_IOS_NE_PROFILE_DEV=$BUILD_IOS_NE_PROFILE_DEV")
